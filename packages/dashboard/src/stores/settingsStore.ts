...
const DEFAULT_ROLES_CONFIG: RoleConfig[] = [
  ...
  { id: 'research-agent', name: 'Research Agent', model: 'anthropic/claude-3.5-sonnet', systemPrompts: [{ userEmail: 'peterschings@gmail.com', userName: 'Peter Schings', prompt: 'You are an expert researcher. Your task is to gather information, analyze data, and provide comprehensive reports.' }], activePromptUserEmail: 'peterschings@gmail.com' },
